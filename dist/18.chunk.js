...
var JvCreateComponent = (function () {
    ...
    JvCreateComponent.prototype.searching = function (e) {
        if (e.keyCode == 13) {
    ...
    JvCreateComponent.prototype.searchAccount = function (searchText) {
        var _this = this;
        this.jvCreateService.searchAccount('JV' + searchText).then(function (data) {
            if (data._id) {
    ...
    JvCreateComponent.prototype.addNew = function () {
        this.accountForm = new __WEBPACK_IMPORTED_MODULE_2__account_model__["a" /* AccountFormModel */]();
